...
namespace ModuleInject.Container.Interface
{
    public interface IDependencyContainer : IDisposable
    {
        ...
        void SetInstanceCreation(string name, Type type, IInstanceCreation instanceCreation);

        void DefinePrerequisite(string name, Type registeredType, IResolvedValue prerequisite);
